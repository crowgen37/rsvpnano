...
private:
    ...
    bool handleInputEvent(const Input::Event& event, uint32_t nowMs);
    bool handleStandbyInput(const Input::Event& event, uint32_t nowMs);
    bool handleMenuInput(const Input::Event& event, uint32_t nowMs);
    bool handleReaderInput(const Input::Event& event, uint32_t nowMs);
    ...
    void openTextEntry(TextEntryPurpose purpose, const String& title, const String& prompt, const String& helperText,
    ...
    void renderStorageStatus(const char* title, const char* line1, const char* line2, int progressPercent);
    static void handleStorageStatus(void* context, const char* title, const char* line1, const char* line2,
                                    int progressPercent);
